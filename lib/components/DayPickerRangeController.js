      ...
      function componentWillReceiveProps(nextProps) {
        ...
        if (didStartDateChange || didEndDateChange) {
          ...
          if (!startDate && !endDate && this.state.hoverDate) {
            modifiers = this.deleteModifierFromRange(modifiers, prevStartDate.clone().subtract(1, 'day'), this.state.hoverDate.clone().add(1, 'day'), // Ideally, this would be prevEndDate... Look at CT implementation
            'hovered-span');
          }
